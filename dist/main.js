      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 6:
            ...
            like = likesData.find(function (like) {
            ...
            return _context2.abrupt("return", like.likes || []);
          case 10:
...
function _fetchAnime() {
  _fetchAnime = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 11:
            _context2.prev = 11;
            _context2.t0 = _context2["catch"](0);
            console.error('Error fetching anime:', _context2.t0);
          case 14:
          case "end":
            return _context2.stop();
        }
...
var modal = document.querySelector('#popup-window');
document.addEventListener('click', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    var popupLink, cardContainer, animeId;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            popupLink = e.target.closest('.popup-link');
            if (popupLink) {
              cardContainer = popupLink.closest('.card__container');
              if (cardContainer) {
                modal.style.display = 'block';
                animeId = cardContainer.getAttribute('data-id');
...
var modalContainer = document.getElementById('popup-window');
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 12:
            ...
            modalContent = "\n      <div>\n        <div class=\"modal__content\">\n          <div class=\"synopsis__container\">\n            <img src=".concat(animeData.data.attributes.posterImage.original, " alt=\"cover\" />\n            <div>\n              <div class=\"name__likes\">\n                <h2>").concat(animeData.data.attributes.canonicalTitle, "</h2>\n                <p>\n                  <i class=\"fa-solid fa-heart like__button ").concat(likedItem.includes(id) ? 'disabled' : '', "\"> </i>\n                  ").concat(likesData.length, "\n                </p>\n              </div>\n              <div class=\"description\">\n                <p>").concat(animeData.data.attributes.synopsis, "</p>\n              </div>\n            </div>\n          </div>\n          <h2 class=\"comments__title\">Comments (").concat(comments.length, ")</h2>\n          <div class=\"comments__container\">\n          <ul>\n          ").concat(Array.isArray(comments) ? comments.length === 0 ? '<li>No comments yet. Be the first to comment!</li>' : comments.map(function (comment) {
              return "<li>".concat(comment.username, ": ").concat(comment.comment, "</li>");
            }).join('') : '<li>Please add a comment!!</li>', "\n        </ul>\n          </div>\n        <div class=\"form__container\" id=\"").concat(animeData.id, "\">\n          <h2>Add a comment</h2>\n          <form class=\"comment__form\">\n            <input type=\"text\" id=\"username\" placeholder=\"Your name...\" />\n            <textarea id=\"commentText\" placeholder=\"Add your comment\"></textarea>\n            <button type=\"submit\">Submit</button>\n          </form>\n        </div>\n      </div>\n    ");
            ...
            commentForm.addEventListener('submit', /*#__PURE__*/function () {
              var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
                var usernameInput, commentTextInput, username, comment, updatedComments, commentsList;
                return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                  while (1) {
                    switch (_context2.prev = _context2.next) {
                      case 0:
                      ...
                      case 11:
                        ...
                        commentsList = document.querySelector('.comments__container ul');
                        commentsList.innerHTML = updatedComments.map(function (comment) {
                          return "<li>".concat(comment.username, ": ").concat(comment.comment, "</li>");
                        }).join('');
...
var url = 'https://us-central1-involvement-api.cloudfunctions.net/capstoneApi/apps/D2Xr8tRh2hyegwFvMhUF/comments';
var postComment = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(id, user, comment) {
    var response, data;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
